# .NET-movie-api
```
1.get data from movies APIs (filmworld and cinemaworld), it will retry 5 times until it is successful, 
then return available API data.
...
4.return a movie list 
```
- Allow origin is enabled in Azure 
